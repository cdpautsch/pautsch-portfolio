...
function setupVariables() {
	...
	resetEle = document.getElementById("create_reset");
}
...
function setupListeners() {
	...
	resetEle.addEventListener("click",resetErrors);
	...
	subjectEle.addEventListener("mouseover", function() { createTooltipTag(subjectEle, tooltipID, "Pick the subject first, and then you can see the list of classes for that subject."); });
	subjectEle.addEventListener("mouseout",removeTooltip);
	
	classEle.addEventListener("mouseover", function() { createTooltipTag(classEle, tooltipID, "Once you have selected a subject, you can pick the appropriate class. Sections are not specified."); });
